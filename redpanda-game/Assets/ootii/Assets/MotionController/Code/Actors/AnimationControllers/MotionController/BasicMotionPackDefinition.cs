...
#pragma warning restore 0219
        ...
        {            
            ...
            AnimatorStateTransition lAnyTransition_32132 = MotionControllerMotion.EditorFindAnyStateTransition(lLayerStateMachine, lBaseState, 0);
        ...
        {            
            ...
            AnimatorStateTransition lAnyTransition_32134 = MotionControllerMotion.EditorFindAnyStateTransition(lLayerStateMachine, lBaseState, 0);
            ...
            lAnyTransition_32134.duration = 0.2f;
        ...
        /// <param name="rLayerIndex"></param>
        /// <param name="rCreateStates"></param>
        public static AnimatorStateMachine EnsureBasicDamagedSSM(AnimatorController rController, int rLayerIndex, bool rCreateStates = true)
        {
            if (rController == null) return null;
            ...
            lDamagedState.tag = "Exit";
            lDamagedState.motion = MotionControllerMotion.EditorFindAnimationClip(DefaultPaths.StandardAnimations + "Utilities/Utilities_01.fbx", "Damaged");

            AnimatorStateTransition lAnyTransition_32690 = MotionControllerMotion.EditorFindAnyStateTransition(lLayerStateMachine, lDamagedState, 0);
            if (lAnyTransition_32690 == null) { lAnyTransition_32690 = lLayerStateMachine.AddAnyStateTransition(lDamagedState); }
            lAnyTransition_32690.isExit = false;
            lAnyTransition_32690.hasExitTime = false;
            lAnyTransition_32690.hasFixedDuration = true;
            lAnyTransition_32690.exitTime = 0.75f;
            lAnyTransition_32690.duration = 0.1f;
            lAnyTransition_32690.offset = 0.106185f;
            lAnyTransition_32690.mute = false;
            lAnyTransition_32690.solo = false;
            lAnyTransition_32690.canTransitionToSelf = true;
            lAnyTransition_32690.interruptionSource = (TransitionInterruptionSource)0;
            for (int i = lAnyTransition_32690.conditions.Length - 1; i >= 0; i--) { lAnyTransition_32690.RemoveCondition(lAnyTransition_32690.conditions[i]); }
            lAnyTransition_32690.AddCondition(AnimatorConditionMode.Equals, 3350f, "L" + rLayerIndex + "MotionPhase");
            lAnyTransition_32690.AddCondition(AnimatorConditionMode.Equals, 0f, "L" + rLayerIndex + "MotionForm");
